...
import com.skpissay.productstock.adapters.CustomRecyclerAdapterForDusk3;
 ...
 */
public class PotUserHomeDuskFragment3 extends DuskFragmentBaseClass implements DuskListener {
    ...
    CustomRecyclerAdapterForDusk3 m_cRecycClassesAdapt;
    ArrayList<Product> m_cProductsList;

    public PotUserHomeDuskFragment3() {
        super();
    }

    public static PotUserHomeDuskFragment3 newInstance(int pPosition, String pKey) {
        PotUserHomeDuskFragment3 lPotUserHomeDuskFragment3 = new PotUserHomeDuskFragment3();

        Bundle args = new Bundle();
        args.putInt("Position", pPosition);
        args.putString("KEY", pKey);
        lPotUserHomeDuskFragment3.setArguments(args);

        return lPotUserHomeDuskFragment3;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        m_cObjMainActivity.m_cObjFragmentBase = PotUserHomeDuskFragment3.this;
...
//                            doPagination(lpage);
        ...
        lParams.put(Constants.CATEGORY_ID, String.valueOf(3));
            ...
            case Constants.PRODUCTS:
                ...
                if (lCategories != null && lCategories.getProducts().size() > 0) {
                    ...
                    if (null != m_cProductsList && m_cProductsList.size() > 0) {
                        m_cRecycClassesAdapt = new CustomRecyclerAdapterForDusk3(m_cObjMainActivity, m_cProductsList, this);
