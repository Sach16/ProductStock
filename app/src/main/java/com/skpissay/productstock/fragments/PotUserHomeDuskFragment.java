 ...
 */
public class PotUserHomeDuskFragment extends DuskFragmentBaseClass implements DuskListener{
    ...
    CustomRecyclerAdapterForDusk m_cRecycClassesAdapt;
    ArrayList<Product> m_cProductsList;

    public PotUserHomeDuskFragment() {
        super();
    }

    public static PotUserHomeDuskFragment newInstance(int pPosition, String pKey) {
        PotUserHomeDuskFragment lPotUserHomeDuskFragment = new PotUserHomeDuskFragment();

        Bundle args = new Bundle();
        args.putInt("Position", pPosition);
        args.putString("KEY", pKey);
        lPotUserHomeDuskFragment.setArguments(args);

        return lPotUserHomeDuskFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        m_cObjMainActivity.m_cObjFragmentBase = PotUserHomeDuskFragment.this;
...
//                            doPagination(lpage);
        ...
        lParams.put(Constants.CATEGORY_ID, String.valueOf(1));
            ...
            case Constants.PRODUCTS:
                ...
                if (lCategories != null && lCategories.getProducts().size() > 0) {
                    ...
                    if (null != m_cProductsList && m_cProductsList.size() > 0) {
                        m_cRecycClassesAdapt = new CustomRecyclerAdapterForDusk(m_cObjMainActivity, m_cProductsList, this);
